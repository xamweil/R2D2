...
SerialProcessor::SerialProcessor(Adafruit_PWMServoDriver &driver1, Adafruit_PWMServoDriver &driver2):
  ...
  lid1_2(driver1, 1, map(20, 0, 180,   _servoMin, _servoMax), map(120, 0, 180,   _servoMin, _servoMax), false),
  lid1_3(driver1, 2, map(10, 0, 180,   _servoMin, _servoMax), map(120, 0, 180,   _servoMin, _servoMax), false),
  lid1_4(driver1, 5, map(0, 0, 180,   _servoMin, _servoMax), map(110, 0, 180,   _servoMin, _servoMax), false),
  lid1_5(driver1, 4, map(8, 0, 180,   _servoMin, _servoMax), map(125, 0, 180,   _servoMin, _servoMax), false),
  lid1_6(driver1, 3, map(10, 0, 180,   _servoMin, _servoMax), map(130, 0, 180,   _servoMin, _servoMax), false),
  lid2_1(driver1, 6, map(20, 0, 180,   _servoMin, _servoMax), map(145, 0, 180,   _servoMin, _servoMax), true),
  lid2_2(driver1, 7, map(50, 0, 180,   _servoMin, _servoMax), map(160, 0, 180,   _servoMin, _servoMax), true),
