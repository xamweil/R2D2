...
#define TASTER_1_PIN D6         // D6
#define TASTER_2_PIN D7         // D7
...
#define NODE_NAME "leg_r_node"
#define TASTER_TOPIC "/leg_r/taster_event"
#define RADAR_TOPIC "/leg_r/radar"
#define TASTER_FRAME_ID "leg_r_taster"
#define RADAR_FRAME_ID "leg_r_radar"
...
void setup() {
  ...
  Serial.println();
  Serial.println("Right leg micro-ROS firmware booting...");
